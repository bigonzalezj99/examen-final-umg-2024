...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aosAnimacion(); ?> class="resumen__bloque">
        ...
        <div <?php aosAnimacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero"><?php echo $asistentesTotal; ?></p>
...
<section class="speakers">
    <h2 class="speakers__heading">Conferencistas</h2>
    <p class="speakers__descripcion">Conozca a nuestros mejores expertos que forman parte de DevWebCamp.</p>

    <div class="speakers__grid">
        <?php
            foreach ($ponentes as $ponente) { 
        ?>
            <div <?php aosAnimacion(); ?> class="speaker">
                <picture>
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div <?php aosAnimacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp/&#62;</h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__plan">Q 199.00</p>
        </div>

        <div <?php aosAnimacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp/&#62;</h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__plan">Q 49.00</p>
        </div>

        <div <?php aosAnimacion(); ?> class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DevWebCamp/&#62;</h4>
            <p class="boleto__plan">Gratis</p>
            <p class="boleto__plan">Q 00.00</p>
        </div>
    </div>
