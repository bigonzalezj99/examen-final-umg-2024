<?php
    ...
    class ActiveRecord {
        ...
        public function sanitizarAtributos() {
            ...
            $sanitizado = array_map('trim', $sanitizado);
        ...
        // Retornar los registros por un orden con unlímite.
        ...
        // Busqueda where con mútiples opciones.
        public static function whereArray($array = []) {
            $query = "SELECT * FROM " . static::$tabla . " WHERE ";

            foreach ($array as $llave => $valor) {
                if ($llave == array_key_last($array)) {
                    $query .= " ${llave} = '${valor}'";
                } else {
            ...
            // Forma rara de solucionar el AND del final.
        ...
        // Traer un total de registros con una array_where.
        ...
        public function crear() {
            ...
            // debuguear($query); // Descomentar si algo no llegara a funcionar.
