<?php
    ...
    class Usuario extends ActiveRecord {
        ...
        protected static $columnasDB = ['id', 'nombre', 'apellido', 'correo', 'contrasena', 'confirmado', 'token', 'admin'];
        ...
        public function validarLogin() {
            ...
            } else if (strlen($this->contrasena) < 6) {
                self::$alertas['error'][] = '¡La contraseña debe contener como mínimo 6 caracteres!';
            }
        ...
        public function nuevaContrasena() : array {
            ...
            } else if (strlen($this->contrasena_nueva) < 6) {
                self::$alertas['error'][] = '¡La nueva contraseña debe contener como mínimo 6 caracteres!';
            }
